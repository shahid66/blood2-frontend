    ...
    <nav className="sticky top-0 z-50 w-full border-b border-red-100 bg-white/80 backdrop-blur-lg shadow-sm">
      <header className="max-w-7xl mx-auto flex h-17.5 items-center justify-between px-4 md:px-6">
        ...
        <Link href="/" className="flex items-center gap-2 group">
          ...
          />
          <span className="text-xl font-bold tracking-tight bg-gradient-to-r from-red-600 to-red-800 bg-clip-text text-transparent">
            Blood<span className="text-gray-900">Bond</span>
          </span>
        </Link>

        {/* ── Right Navigation & Actions Panel ── */}
        <div className="flex items-center gap-4">
          {/* ── Desktop Nav Links (Placed right before actions) ── */}
          ...
          <div className="flex items-center gap-3">
            {!user ? (
              ...
              <>
                <Link
                  href="/auth/signin"
                  className="hidden md:inline-flex items-center justify-center gap-1.5 px-4 py-2 text-sm font-semibold text-gray-700 border border-gray-200 rounded-lg hover:border-red-300 hover:text-red-600 hover:bg-red-50/50 transition-all duration-200"
                >
            ...
            <>
              <li>
                <Link
                  href="/auth/signin"
                  onClick={() => setIsMenuOpen(false)}
                  className="flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-semibold text-gray-600 hover:text-red-600 hover:bg-red-50"
                >
                  <TbLogin2 size={18} />
                  Login
                </Link>
              ...
              <li>
                <Link
                  href="/auth/register"
                  onClick={() => setIsMenuOpen(false)}
                  className="flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-semibold text-white bg-red-600 hover:bg-red-700 text-center justify-center shadow-sm"
                >
            ...
            <>
              ...
              <li>
                <button
                  ...
                  className="w-full flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-semibold text-red-600 hover:bg-red-50 disabled:opacity-50"
                >
                  <MdLogout size={18} />
