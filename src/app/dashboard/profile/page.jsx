...
export async function generateMetadata() {
  ...
  return {
    ...
    description: `Manage your personal information and donor credentials on BloodBond. Welcome, ${userName}!`,
    keywords: [
      "blood donation",
      "donate blood",
      "blood bank",
    ...
    openGraph: {
      title: `${userName} - Profile Settings | BloodBond`,
      description: `Manage your donor profile and credentials on BloodBond.`,
      type: "website",
    },
  };
}
