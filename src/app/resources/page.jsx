export const metadata = {
  title: "Resources",
  description:
    "Explore helpful resources about BloodBond including About Us, FAQ, Privacy Policy, and Terms & Conditions.",
  keywords: [
    "blood donation resources",
    "BloodBond help",
    "faq blood donation",
    "privacy policy BloodBond",
...
export default function ResourcesPage() {
  const items = [
    {
      title: "About Us",
      desc: "Learn about BloodBond mission and vision.",
      icon: <FaInfoCircle />,
    ...
    },
    {
      ...
      desc: "Rules and usage guidelines of BloodBond.",
      icon: <FaFileContract />,
      ...
      <section className="max-w-6xl mx-auto px-4 md:px-6 py-20">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">
            Everything you need to understand and use BloodBond.
          </p>
        </div>
