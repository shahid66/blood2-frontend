...
export const metadata = {
  title: "About Us",
  description:
    "Learn about BloodBond mission, vision, and how we connect blood donors with patients in need.",
  keywords: [
    "about BloodBond",
...
export default function AboutPage() {
  return (
    <main className="max-w-5xl mx-auto px-4 py-20">
      ...
      <h1 className="text-4xl font-bold text-gray-900">About BloodBond</h1>

      <p className="mt-6 text-gray-600 leading-7">
        BloodBond is a platform designed to connect blood donors with patients
