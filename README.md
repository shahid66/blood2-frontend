\# 🩸 BloodBond — Every Drop Counts

<div align="center">

![BloodBond Banner](https://raw.githubusercontent.com/shahadat-hossain99/BloodBond-client/main/public/assets/nav-logo.png)

**A modern blood donation platform connecting donors with those in need.**

[![Live Demo](https://img.shields.io/badge/🌐_Live_Demo-Visit_Site-dc2626?style=for-the-badge)](https://BloodBond-every-drop-counts.vercel.app/)
...
**BloodBond** is a full-stack blood donation management platform built to bridge the gap between blood donors and recipients. The platform enables users to register as donors, create blood donation requests, search for compatible donors, and fund the organization — all in one seamless experience.
...
| Resource             | Link                                                                                      |
| -------------------- | ----------------------------------------------------------------------------------------- |
| 🌐 Live Site         | [BloodBond-every-drop-counts.vercel.app](https://BloodBond-every-drop-counts.vercel.app/) |
| 💻 Client Repository | [GitHub — BloodBond-client](https://github.com/tirthosarkar/BloodBond-client)       |
| 🖥️ Server Repository | [GitHub — BloodBond-server](https://github.com/tirthosarkar/BloodBond-server)       |
...
<!-- | Role         | Email                     | Password         |
| ------------ | ------------------------- | ---------------- |
| 👑 Admin     | `admin@BloodBond.com`     | `Admin@1234`     |
| 🤝 Volunteer | `volunteer@BloodBond.com` | `Volunteer@1234` |
| 🩸 Donor     | `donor@BloodBond.com`     | `Donor@1234`     | -->
...
```bash
git clone https://github.com/your-username/BloodBond-client.git
cd BloodBond-client
```
...
# MongoDB
MONGODB_URI=mongodb+srv://<username>:<password>@cluster.mongodb.net/BloodBond
...
[![Vercel](https://img.shields.io/badge/Deployed_on-Vercel-000000?style=flat-square&logo=vercel)](https://BloodBond-every-drop-counts.vercel.app/)
...
**BloodBond was born to solve exactly this.**
...
The name _BloodBond_ reflects the core mission — **synchronizing** the right blood with the right person, at the right time.

---

## 🧩 Problems BloodBond Solves

| Problem                         | How BloodBond Solves It                                                      |
| ------------------------------- | ---------------------------------------------------------------------------- |
